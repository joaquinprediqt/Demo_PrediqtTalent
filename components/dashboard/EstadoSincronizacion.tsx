  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-control border border-line bg-surface px-3.5 py-2.5 text-[13.5px] font-medium text-ink-2">
      ...
      <button
        ...
        className="rounded-[6px] border border-line-input px-2 py-1 text-[12px] font-semibold text-steel transition-colors hover:border-accent hover:text-accent disabled:opacity-60"
      >
